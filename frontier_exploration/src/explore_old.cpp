...
namespace frontier_exploration {
	...
	_headingSub = _nh->subscribe<std_msgs::Int16>("/current_heading", 1000, &Explore::updateHeading, this);
    ...
    // revised by pileun 20231207
    void Explore::updateHeading(const std_msgs::Int16::ConstPtr& msg)
    {
	_search._heading = msg->data;
    }
